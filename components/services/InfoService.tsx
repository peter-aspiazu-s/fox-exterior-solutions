...
export const InfoServices: FC<InfoProps> = ({image, alt, title, description}) => {

    return(
        <div className="infoservices">
            <div className="infoservices__container">
                <div className="infoservices__container-text">
                    <div className="infoservices__title">{title}</div>
                    <div className="infoservices__description">{description}</div>
