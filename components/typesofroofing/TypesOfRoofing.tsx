                ...
                <div className="typesofroofing__container-types">
                    <div className="typesofroofing__type">
                        ...
                        <div className="typesofroofing__type-image">
                            <Image src="/images/metal-roofs-graphic.webp" alt="Metal Roofs image" layout="fill" />
                        </div>
                    </div>
                    <div className="typesofroofing__type">
                        ...
                        <div className="typesofroofing__type-image">
                            <Image src="/images/asphalt-shingles-graphic.webp" alt="Asphalt Shingles image" layout="fill" />
                        </div>
                    </div>
                    <div className="typesofroofing__type">
                        ...
                        <div className="typesofroofing__type-image">
                            <Image src="/images/flat-roofs.webp" alt="Flat Roofs image" layout="fill" />
                        </div>
                    </div>
                    <div className="typesofroofing__type">
                        ...
                        <div className="typesofroofing__type-image">
                            <Image src="/images/rubber-roofs.webp" alt="Rubber Roofs image" layout="fill" />
                        </div>
                    </div>
                </div>
            </div>
