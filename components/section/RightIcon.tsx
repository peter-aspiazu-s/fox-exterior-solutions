...
export const RightIcon:FC = () => {
    ...
    return (
        <svg className="righticon" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
            width="612.02px" height="612.02px" viewBox="0 0 612.02 612.02"
            xmlSpace="preserve">
            <g>
                <g id="_x35__11_">
                    <g>
